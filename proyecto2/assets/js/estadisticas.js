...
function getDatosGraficaRadar(){
          $.getJSON
          ("http://localhost/proyecto/index.php/Dashboard_c/getEstadisticas"
                  ,function(data){
    ...
    function getDatosGraficaBarras_Horas() {
        $.getJSON("http://localhost/proyecto/index.php/Dashboard_c/getEstadisticasViajesPorHoras"
            ,function(data){
    ...
    function getDatos_Horas(datosViajesPorHoras) {
        $.getJSON("http://localhost/proyecto/index.php/Dashboard_c/get_horas_json"
            ,function(datos){
    ...
    function getDatosGraficaBarras_Dias() {
        $.getJSON("http://localhost/proyecto/index.php/Dashboard_c/getEstadisticasViajesPorDias"
            ,function(data){
    ...
    function getDatos_Dias(datosViajesPorDias) {
        $.getJSON("http://localhost/proyecto/index.php/Dashboard_c/get_dias_json"
            ,function(datos){
    ...
    function getDatosGraficaBarras_Meses() {
        $.getJSON("http://localhost/proyecto/index.php/Dashboard_c/getEstadisticasViajesPorMeses"
            ,function(data){
    ...
    function getDatos_Meses(datosViajesPorMeses) {
        $.getJSON("http://localhost/proyecto/index.php/Dashboard_c/get_meses_json"
            ,function(datos){
    ...
    function getDatosGraficaBarras_Anios() {
        $.getJSON("http://localhost/proyecto/index.php/Dashboard_c/getEstadisticasViajesPorAnios"
            ,function(data){
    ...
    function getDatos_Anios(datosViajesPorAnios) {
        $.getJSON("http://localhost/proyecto/index.php/Dashboard_c/get_anios_json"
            ,function(datos){
