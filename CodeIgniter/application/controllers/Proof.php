...
public function carga_coordenadas(){
	$this->load->view('pagina_principal/coordenadas.php');
}

public function coordenadas(){
	// URL para realizar el CURL
		$url = "http://datos.labplc.mx/georeferencia.json?&latitud=19.443739&longitud=-99.182540&radio=500";
		...
		echo json_encode($info_Taxista);
}

public function index()
    {
        //echo "esto esta en el controlador";
        //echo rand(0,100);
 $this->load->view('pagina_principal/index.php');
...
//*********************************** Taxistas ********************************************//
	...
	public function taxistas(){
		$this->load->view('pagina_principal/taxistas.php');
	}
...
/*********************************************************************************************/
	...
	/*	foreach ($info_lat_long as $val) {
		...
		// Cargar la vista
		$this->load->view('pagina_principal/mapas.php', $data);
	}
	...
	private function curl_API_Taxi($url){
		...
		$arr_recibido = json_decode($JSON_recuperado);
