...
function getDatosGraficaRadar(){
          $.getJSON
          ("http://127.0.0.1/proyecto/index.php/Dashboard_c/getEstadisticas"
                  ,function(data){
    ...
    function getDatosGraficaBarras_Horas() {
        $.getJSON("http://127.0.0.1/proyecto/index.php/Dashboard_c/getEstadisticasViajesPorHoras"
            ,function(data){
    ...
    function getDatos_Horas(datosViajesPorHoras) {
        $.getJSON("http://127.0.0.1/proyecto/index.php/Dashboard_c/get_horas_json"
            ,function(datos){
    ...
    function getDatosGraficaBarras_Dias() {
        $.getJSON("http://127.0.0.1/proyecto/index.php/Dashboard_c/getEstadisticasViajesPorDias"
            ,function(data){
    ...
    function getDatos_Dias(datosViajesPorDias) {
        $.getJSON("http://127.0.0.1/proyecto/index.php/Dashboard_c/get_dias_json"
            ,function(datos){
    ...
    function getDatosGraficaBarras_Meses() {
        $.getJSON("http://127.0.0.1/proyecto/index.php/Dashboard_c/getEstadisticasViajesPorMeses"
            ,function(data){
    ...
    function getDatos_Meses(datosViajesPorMeses) {
        $.getJSON("http://127.0.0.1/proyecto/index.php/Dashboard_c/get_meses_json"
            ,function(datos){
    ...
    function getDatosGraficaBarras_Anios() {
        $.getJSON("http://127.0.0.1/proyecto/index.php/Dashboard_c/getEstadisticasViajesPorAnios"
            ,function(data){
    ...
    function getDatos_Anios(datosViajesPorAnios) {
        $.getJSON("http://127.0.0.1/proyecto/index.php/Dashboard_c/get_anios_json"
            ,function(datos){
